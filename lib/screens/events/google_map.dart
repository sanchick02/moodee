...
class EventDirectory extends StatefulWidget {
  final double lat;
  final double lng;
  EventDirectory(this.lat, this.lng);
...
class _EventDirectoryState extends State<EventDirectory> {
            ...
            child: Container(
              ...
              child:  Center(
                child: IconButton(
                  ...
                  onPressed: () async {
                    String apiKey = 'AIzaSyA0AiV1cofl1me1ndNKKpuSe4xsGIz_8t4';
                    String destination = '${widget.lat},${widget.lng}';
                    String url = 'google.navigation:q=$destination&key=$apiKey';
  ...
  getDirections(LatLng dst) async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      'AIzaSyA0AiV1cofl1me1ndNKKpuSe4xsGIz_8t4', 
